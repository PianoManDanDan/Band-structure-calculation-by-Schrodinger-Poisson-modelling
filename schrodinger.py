...
try:
    ...
    raise ImportError('The schrodinger class requires scipy, numpy and matplotlib to be installed.\
                       Please install these modules before continuing.')


# Define Schrodinger class
class Schrodinger:
    """
    Class to implement numerical solution of TISE
